...
•	Јане Џумеркоски 121119

•	Виктор Илиески  123012

Изворниот код од играта може да се најде на github: http://www.github.com/dekob/blackjack
...
![Alt text](https://cloud.githubusercontent.com/assets/6113453/2935555/56bcfc7e-d818-11e3-9133-d55088614058.PNG)
...
![Alt text](https://cloud.githubusercontent.com/assets/6113453/2935557/6c6418e6-d818-11e3-9109-496f2b672792.PNG)
...
![Финална слика](https://cloud.githubusercontent.com/assets/6113453/2971544/b676f074-db6b-11e3-9f84-fd56bea38ff2.PNG)
...
Во класата Karta чуваме информации кои се поврзани за картата и тоа:
      ...
      •	Boja – Соодветна Int- променлива која претставува бојата на картата (ограничена на 1-4). Секој број претставу ва една боја и тоа (1- детелина, 2- црн лист, 3- каро, 4-срце)
